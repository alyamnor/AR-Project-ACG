...
//                     Color emissionColor = Color.Lerp(new Color(0.588f, 0.588f, 0.588f), new Color(0.078f, 0.078f, 0.078f), t); // Bright to dark
...
//                         if (selectedItem != null)
//                         {
//                             DisableEmission(selectedItem); // Disable emission on the previously selected item
//                             Debug.Log($"Switching selection from: {selectedItem.name} to: {obj.name}");
//                         }
//                         selectedItem = obj;

//                         EnableEmission(selectedItem); // Enable emission on the newly selected item
//                         isDragging = true;
...
//                 if (isEmptySpace)
//                 {
//                     DisableEmission(selectedItem); // Disable emission on deselection
...
//                 // Apply the emission map if assigned
//                 if (emissionMap != null)
//                 {
