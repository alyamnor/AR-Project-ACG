...
// /// - Create Input Actions in Unity (TouchControls with <Pointer>/press, <Touchscreen>/primaryTouch/position, <Touchscreen>/secondaryTouch/position, and <Touchscreen>/touchCount).
...
// ///   - Two-finger pinch: Scales the selected object up (pinch out) or down (pinch in).
...
//         {
//             int touchCount = controls.control.touchCount.ReadValue<int>();
//             Debug.Log("Touch count: " + touchCount);
//             Vector2 touch0Pos = controls.control.primaryTouch.ReadValue<Vector2>();
//             Vector2 touch1Pos = controls.control.secondaryTouch.ReadValue<Vector2>();
//             Debug.Log($"Touch positions: {touch0Pos}, {touch1Pos}");
//             if (touchCount >= 2)
//             {
//                 touch0Pos = controls.control.primaryTouch.ReadValue<Vector2>();
//                 touch1Pos = controls.control.secondaryTouch.ReadValue<Vector2>();
...
//             else
//             {
//                 previousPinchDistance = 0; // Reset when not pinching
//             }
//         }
...
//             if (touchCount > 1)
//             {
//                 // Two-finger touch handled in Update()
//                 return;
//             }
