...
// ///   - Release touch to stop dragging (object remains selected, stops following raycast).
// ///   - Click an empty space on a plane to deselect the object.
...
//     {
//         // Check if the touch hits a plane using ARRaycastManager
//         if (aRRaycastManager.Raycast(screenPosition, hits, TrackableType.PlaneWithinPolygon))
//         {
//             var hitPose = hits[0].pose;
...
//                     selectedItem = null;
//                     isDragging = false; // Stop dragging on deselection
//                     return; // Exit to avoid spawning
//                 }
//             }

//             // If no object is selected, spawn a new object on the plane
//             if (selectedItem == null)
//             {
...
//     {
//         // Stop dragging but keep the object selected
//         if (isDragging)
//         {
//             isDragging = false;
