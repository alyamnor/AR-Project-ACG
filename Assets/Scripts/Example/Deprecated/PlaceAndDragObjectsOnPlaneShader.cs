...
// /// <summary>
// /// Script to manipulate AR objects with translation, scaling, and rotation modes, using a shader-based outline effect.
...
// /// - Assign a material using the OutlinePulseShader to <see cref="outlineMaterial"/> in the Inspector.
// ///
// /// Interaction:
// /// - Select a mode via ModeSelector UI buttons (Translation, Scaling, Rotation).
// /// - Select a prefab to spawn via the dropdown.
// /// - In Translation mode:
// ///   - Click a spawned object to select it; a pulsing outline (via shader) highlights it, and the delete button appears.
...
//     /// <summary>
//     /// Material using OutlinePulseShader for the outline effect.
//     /// </summary>
//     [SerializeField]
//     [Tooltip("Material using OutlinePulseShader for the outline effect.")]
...
//     /// <summary>
//     /// Original material of the selected item before applying outline.
//     /// </summary>
...
//         if (selectedItem != null && outlineMaterial != null)
//         {
//             float pulseValue = Mathf.PingPong(Time.time * pulseSpeed, 1f);
//             outlineMaterial.SetFloat("_Pulse", pulseValue);
//         }
//     }
...
//         if (selectedItem != null && outlineMaterial != null)
//         {
//             Renderer renderer = selectedItem.GetComponent<Renderer>();
//             if (renderer != null)
//             {
//                 originalMaterial = renderer.material;
//                 renderer.material = outlineMaterial;
//                 Debug.Log($"Applied outline material to: {selectedItem.name}");
//             }
//         }
//     }
...
//     {
//         if (selectedItem != null && originalMaterial != null)
//         {
//             Renderer renderer = selectedItem.GetComponent<Renderer>();
//             if (renderer != null)
//             {
//                 renderer.material = originalMaterial;
//                 Debug.Log($"Restored original material to: {selectedItem.name}");
//             }
//         }
